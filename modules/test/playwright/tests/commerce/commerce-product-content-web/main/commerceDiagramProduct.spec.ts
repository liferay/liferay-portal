...
test(
	'Account Supplier role user can upload diagram file/image',
	{tag: '@COMMERCE-11835'},
	async ({
		apiHelpers,
...
test(
	...
	{tag: ['@COMMERCE-8207', '@COMMERCE-8068', '@LPD-76575']},
	async ({
		apiHelpers,
		commerceAdminChannelsPage,
		page,
...
test(
	'Pins created through the diagram editor are saved with all their information',
	{tag: ['@COMMERCE-7025', '@LPD-76575']},
	async ({
		apiHelpers,
		commerceAdminProductDetailsDiagramPage,
		commerceAdminProductDetailsPage,
		...
		await test.step('Check the mapped products table saved every pin against its position', async () => {
			for (const [index, value] of [
				...
				await expect(
					commerceAdminProductDetailsDiagramPage.mappedProductRowAt(
						index
					)
				).toContainText(value);
			}
...
test(
	'Pins can be edited and removed through the diagram editor',
	{tag: '@LPD-76575'},
	async ({
		apiHelpers,
		commerceAdminProductDetailsDiagramPage,
...
test(
	'The diagram pin size and full screen controls change the canvas',
	{tag: ['@COMMERCE-7022', '@COMMERCE-7023', '@LPD-76575']},
	async ({
		apiHelpers,
		commerceAdminProductDetailsDiagramPage,
		commerceAdminProductDetailsPage,
...
test(
	'A diagram product cannot be published without an image',
	{tag: ['@COMMERCE-7024', '@LPD-76575']},
	async ({
		apiHelpers,
		commerceAdminProductDetailsDiagramPage,
		commerceAdminProductDetailsPage,
...
test(
	'The diagram image can be uploaded and replaced',
	{tag: ['@COMMERCE-7020', '@COMMERCE-7024', '@LPD-76575']},
	async ({
		apiHelpers,
		commerceAdminProductDetailsDiagramPage,
		commerceAdminProductDetailsPage,
...
test(
	...
	{tag: ['@COMMERCE-7019', '@COMMERCE-7126', '@LPD-76575']},
...
test(
	...
	{tag: ['@COMMERCE-7100', '@COMMERCE-7021', '@LPD-76575']},
	async ({
		apiHelpers,
		commerceAdminProductDetailsDiagramPage,
		commerceAdminProductDetailsPage,
