...
import com.liferay.search.experiences.rest.client.dto.v2_0.AggregationConfiguration;
...
public class AggregationConfigurationSerDes {
	...
	public static String toJSON(
		...
		if (aggregationConfiguration.getAggregations() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			if (aggregationConfiguration.getAggregations() instanceof String) {
				sb.append("\"");
				sb.append((String)aggregationConfiguration.getAggregations());
				sb.append("\"");
			}
			else {
				sb.append(aggregationConfiguration.getAggregations());
			}
		}
	...
	public static Map<String, String> toMap(
		...
		if (aggregationConfiguration.getAggregations() == null) {
			...
			map.put(
				"aggregations",
				String.valueOf(aggregationConfiguration.getAggregations()));
		}
	...
	public static class AggregationConfigurationJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "aggregations")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "aggregations")) {
				if (jsonParserFieldValue != null) {
					aggregationConfiguration.setAggregations(
