...
import com.liferay.search.experiences.rest.client.dto.v2_0.SortConfiguration;
...
public class SortConfigurationSerDes {
	...
	public static String toJSON(SortConfiguration sortConfiguration) {
		...
		if (sortConfiguration.getSorts() != null) {
			...
			for (int i = 0; i < sortConfiguration.getSorts().length; i++) {
				sb.append(_toJSON(sortConfiguration.getSorts()[i]));

				if ((i + 1) < sortConfiguration.getSorts().length) {
					sb.append(", ");
				}
			}
