...
import com.liferay.search.experiences.rest.client.dto.v2_0.Configuration;
...
public class ConfigurationSerDes {
	...
	public static String toJSON(Configuration configuration) {
		...
		if (configuration.getConditionConfiguration() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				String.valueOf(configuration.getConditionConfiguration()));
		}
		...
		if (configuration.getPostFilterConfiguration() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				String.valueOf(configuration.getPostFilterConfiguration()));
		}
		...
		if (configuration.getRescoreConfiguration() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(configuration.getRescoreConfiguration()));
		}

		if (configuration.getScopeConfiguration() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			if (configuration.getScopeConfiguration() instanceof String) {
				sb.append("\"");
				sb.append((String)configuration.getScopeConfiguration());
				sb.append("\"");
			}
			else {
				sb.append(configuration.getScopeConfiguration());
			}
		}
	...
	public static Map<String, String> toMap(Configuration configuration) {
		...
		if (configuration.getConditionConfiguration() == null) {
			map.put("conditionConfiguration", null);
		}
		else {
			map.put(
		...
		if (configuration.getPostFilterConfiguration() == null) {
			map.put("postFilterConfiguration", null);
		}
		else {
			map.put(
		...
		if (configuration.getRescoreConfiguration() == null) {
			map.put("rescoreConfiguration", null);
		}
		else {
			map.put(
				"rescoreConfiguration",
				String.valueOf(configuration.getRescoreConfiguration()));
		}

		if (configuration.getScopeConfiguration() == null) {
			map.put("scopeConfiguration", null);
		}
		else {
			map.put(
				"scopeConfiguration",
				String.valueOf(configuration.getScopeConfiguration()));
		}
	...
	public static class ConfigurationJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "advancedConfiguration")) {
				...
				return false;
						...
						jsonParserFieldName, "conditionConfiguration")) {
				...
				return false;
						...
						jsonParserFieldName, "postFilterConfiguration")) {
				...
				return false;
						...
						jsonParserFieldName, "rescoreConfiguration")) {

				return false;
			}
			else if (Objects.equals(
						jsonParserFieldName, "scopeConfiguration")) {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "advancedConfiguration")) {
				...
				if (jsonParserFieldValue != null) {
					configuration.setConditionConfiguration(
						ConditionConfigurationSerDes.toDTO(
							(String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					configuration.setPostFilterConfiguration(
						PostFilterConfigurationSerDes.toDTO(
							(String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					configuration.setRescoreConfiguration(
						RescoreConfigurationSerDes.toDTO(
							(String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					configuration.setScopeConfiguration(
						(Object)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(
