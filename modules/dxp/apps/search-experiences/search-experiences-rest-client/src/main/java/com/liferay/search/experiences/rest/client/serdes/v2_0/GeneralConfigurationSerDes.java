...
import com.liferay.search.experiences.rest.client.dto.v2_0.GeneralConfiguration;
...
public class GeneralConfigurationSerDes {
	...
	public static String toJSON(GeneralConfiguration generalConfiguration) {
		...
		if (generalConfiguration.getApplyIndexerClauses() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(generalConfiguration.getApplyIndexerClauses());
		}
	...
	public static Map<String, String> toMap(
		...
		if (generalConfiguration.getApplyIndexerClauses() == null) {
			...
			map.put(
				"applyIndexerClauses",
				String.valueOf(generalConfiguration.getApplyIndexerClauses()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "applyIndexerClauses")) {
				if (jsonParserFieldValue != null) {
					generalConfiguration.setApplyIndexerClauses(
