...
import com.liferay.search.experiences.rest.client.serdes.v2_0.RescoreConfigurationSerDes;
 ...
 */
@Generated("")
public class RescoreConfiguration implements Cloneable, Serializable {

	public static RescoreConfiguration toDTO(String json) {
		return RescoreConfigurationSerDes.toDTO(json);
	}
	...
	@Override
	public RescoreConfiguration clone() throws CloneNotSupportedException {
		return (RescoreConfiguration)super.clone();
	}
	...
	public String toString() {
		return RescoreConfigurationSerDes.toJSON(this);
	}
