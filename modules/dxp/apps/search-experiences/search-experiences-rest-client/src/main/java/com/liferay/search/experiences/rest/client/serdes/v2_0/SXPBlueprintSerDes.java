...
import com.liferay.search.experiences.rest.client.dto.v2_0.ElementInstance;
...
public class SXPBlueprintSerDes {
	...
	public static String toJSON(SXPBlueprint sxpBlueprint) {
		...
		if (sxpBlueprint.getCollectionProvider() != null) {
			...
			sb.append(sxpBlueprint.getCollectionProvider());
		}
	...
	public static Map<String, String> toMap(SXPBlueprint sxpBlueprint) {
		...
		if (sxpBlueprint.getCollectionProvider() == null) {
			...
			map.put(
				"collectionProvider",
				String.valueOf(sxpBlueprint.getCollectionProvider()));
		}
