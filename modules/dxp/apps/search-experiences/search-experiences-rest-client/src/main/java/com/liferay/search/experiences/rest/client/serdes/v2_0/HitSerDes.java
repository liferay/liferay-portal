...
import com.liferay.search.experiences.rest.client.dto.v2_0.DocumentField;
import com.liferay.search.experiences.rest.client.dto.v2_0.Hit;
...
public class HitSerDes {
	...
	public static String toJSON(Hit hit) {
		...
		if (hit.getAssetSearchSummary() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(hit.getAssetSearchSummary()));

			sb.append("\"");
		}

		if (hit.getAssetTitle() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(hit.getAssetTitle()));
	...
	public static Map<String, String> toMap(Hit hit) {
		...
		if (hit.getAssetSearchSummary() == null) {
			map.put("assetSearchSummary", null);
		}
		else {
			map.put(
				"assetSearchSummary",
				String.valueOf(hit.getAssetSearchSummary()));
		}
		...
		if (hit.getAssetTitle() == null) {
			...
			map.put("assetTitle", String.valueOf(hit.getAssetTitle()));
		}
	...
	public static class HitJSONParser extends BaseJSONParser<Hit> {
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "assetSearchSummary")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "assetSearchSummary")) {
				if (jsonParserFieldValue != null) {
					hit.setAssetSearchSummary((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "assetTitle")) {
				if (jsonParserFieldValue != null) {
					hit.setAssetTitle((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "documentFields")) {
				if (jsonParserFieldValue != null) {
