...
import com.liferay.search.experiences.rest.client.dto.v2_0.SXPElement;
...
import com.liferay.search.experiences.rest.client.serdes.v2_0.SXPElementSerDes;
	...
	public static class SXPElementResourceImpl implements SXPElementResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/export-batch");
		...
		public HttpInvoker.HttpResponse postSXPElementBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/by-external-reference-code/{externalReferenceCode}");
		...
		public HttpInvoker.HttpResponse postSXPElementPreviewHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/preview");
		...
		public HttpInvoker.HttpResponse postSXPElementValidateHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/validate");
		...
		public HttpInvoker.HttpResponse deleteSXPElementHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/{sxpElementId}");
		...
		public HttpInvoker.HttpResponse deleteSXPElementBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/{sxpElementId}/batch");
		...
		public HttpInvoker.HttpResponse postSXPElementCopyHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/{sxpElementId}/copy");
		...
		public HttpInvoker.HttpResponse getSXPElementExportHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v2.0/sxp-elements/{sxpElementId}/export");
