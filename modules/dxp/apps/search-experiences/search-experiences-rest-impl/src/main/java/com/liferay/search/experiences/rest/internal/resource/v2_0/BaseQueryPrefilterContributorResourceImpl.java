...
public abstract class BaseQueryPrefilterContributorResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/search-experiences-rest/v2.0/query-prefilter-contributors'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Gets the query prefilter contributors"
	)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v2.0/query-prefilter-contributors/export-batch'  -u 'test@liferay.com:test'
	 */
