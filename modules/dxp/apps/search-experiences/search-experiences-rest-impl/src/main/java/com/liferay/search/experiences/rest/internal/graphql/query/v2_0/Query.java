...
package com.liferay.search.experiences.rest.internal.graphql.query.v2_0;
...
import com.liferay.search.experiences.rest.dto.v2_0.ElementInstance;
import com.liferay.search.experiences.rest.dto.v2_0.FieldMappingInfo;
import com.liferay.search.experiences.rest.dto.v2_0.KeywordQueryContributor;
import com.liferay.search.experiences.rest.dto.v2_0.ModelPrefilterContributor;
import com.liferay.search.experiences.rest.dto.v2_0.QueryPrefilterContributor;
...
import com.liferay.search.experiences.rest.dto.v2_0.SXPParameterContributorDefinition;
import com.liferay.search.experiences.rest.dto.v2_0.SearchIndex;
import com.liferay.search.experiences.rest.dto.v2_0.SearchableAssetName;
...
public class Query {
	 ...
	 */
	@GraphQLField(description = "Gets the field mappings")
	 ...
	 */
	@GraphQLField(description = "Gets the keyword query contributors")
	 ...
	 */
	@GraphQLField(description = "Gets the model prefilter contributors")
	 ...
	 */
	@GraphQLField(description = "Gets the query prefilter contributors")
	 ...
	 */
	@GraphQLField(description = "Gets the Blueprints")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {sXPBlueprintByExternalReferenceCode(externalReferenceCode: ___){actions, collectionProvider, configuration, createDate, description, description_i18n, elementInstances, externalReferenceCode, fallbackDescription, fallbackTitle, id, modifiedDate, schemaVersion, title, title_i18n, userName, version}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Gets a Blueprint by external reference code")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {sXPBlueprint(sxpBlueprintId: ___){actions, collectionProvider, configuration, createDate, description, description_i18n, elementInstances, externalReferenceCode, fallbackDescription, fallbackTitle, id, modifiedDate, schemaVersion, title, title_i18n, userName, version}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Gets a Blueprint")
	 ...
	 */
	@GraphQLField(description = "Exports a Blueprint")
	 ...
	 */
	@GraphQLField(description = "Gets the Elements")
	 ...
	 */
	@GraphQLField(description = "Gets an Element by external reference code")
	 ...
	 */
	@GraphQLField(description = "Gets an Element")
	 ...
	 */
	@GraphQLField(description = "Gets the index names")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {searchableAssetNamesLanguage(languageId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Gets the searchable asset names")
	public SearchableAssetNamePage searchableAssetNamesLanguage(
		...
		return _applyComponentServiceObjects(
			...
			searchableAssetNameResource -> new SearchableAssetNamePage(
				searchableAssetNameResource.getSearchableAssetNamesLanguagePage(
					languageId)));
	}
