...
package com.liferay.search.experiences.rest.internal.graphql.mutation.v2_0;
...
import com.liferay.search.experiences.rest.dto.v2_0.SearchResponse;
...
public class Mutation {
	...
	@GraphQLField(description = "Creates a Blueprint")
	...
	@GraphQLField(description = "Creates or updates a Blueprint")
	...
	@GraphQLField(description = "Validates a Blueprint")
	...
	@GraphQLField(description = "Deletes a Blueprint")
	...
	@GraphQLField(description = "Updates a Blueprint")
	...
	@GraphQLField(description = "Creates a copy of a Blueprint")
	...
	@GraphQLField(description = "Creates an Element")
	...
	@GraphQLField(description = "Creates or updates an Element")
	...
	@GraphQLField(description = "Creates an Element preview")
	...
	@GraphQLField(description = "Validates an Element")
	...
	@GraphQLField(description = "Deletes an Element")
	...
	@GraphQLField(description = "Updates an Element")
	...
	@GraphQLField(
		description = "Does a search using the provided Blueprint. This API is only for the Blueprints application's preview. For a search API, use search/v1.0/search instead."
	)
