...
public abstract class BaseFieldMappingInfoResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/search-experiences-rest/v2.0/field-mapping-infos'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Gets the field mappings"
	)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v2.0/field-mapping-infos/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
