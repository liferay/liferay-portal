...
public abstract class BaseSXPParameterContributorDefinitionResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/search-experiences-rest/v2.0/sxp-parameter-contributor-definitions'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v2.0/sxp-parameter-contributor-definitions/export-batch'  -u 'test@liferay.com:test'
	 */
