...
public class Configuration implements Serializable {
	...
	public ConditionConfiguration getConditionConfiguration() {
		if (_conditionConfigurationSupplier != null) {
			conditionConfiguration = _conditionConfigurationSupplier.get();

			_conditionConfigurationSupplier = null;
		}
	...
	public void setConditionConfiguration(
		...
		_conditionConfigurationSupplier = () -> {
			try {
				return conditionConfigurationUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<ConditionConfiguration> _conditionConfigurationSupplier;
	...
	public PostFilterConfiguration getPostFilterConfiguration() {
		if (_postFilterConfigurationSupplier != null) {
			postFilterConfiguration = _postFilterConfigurationSupplier.get();

			_postFilterConfigurationSupplier = null;
		}
	...
	public void setPostFilterConfiguration(
		...
		_postFilterConfigurationSupplier = () -> {
			try {
				return postFilterConfigurationUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<PostFilterConfiguration> _postFilterConfigurationSupplier;
	...
	public RescoreConfiguration getRescoreConfiguration() {
		if (_rescoreConfigurationSupplier != null) {
			rescoreConfiguration = _rescoreConfigurationSupplier.get();

			_rescoreConfigurationSupplier = null;
		}
	...
	public void setRescoreConfiguration(
		...
		_rescoreConfigurationSupplier = () -> {
			try {
				return rescoreConfigurationUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<RescoreConfiguration> _rescoreConfigurationSupplier;

	@Schema
	@Valid
	public Object getScopeConfiguration() {
		if (_scopeConfigurationSupplier != null) {
			scopeConfiguration = _scopeConfigurationSupplier.get();

			_scopeConfigurationSupplier = null;
		}
	...
	public void setScopeConfiguration(
		...
		_scopeConfigurationSupplier = () -> {
			try {
				return scopeConfigurationUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Object> _scopeConfigurationSupplier;
	...
	public String toString() {
		...
		if (conditionConfiguration != null) {
			...
			sb.append("\"conditionConfiguration\": ");

			sb.append(String.valueOf(conditionConfiguration));
		}
		...
		if (postFilterConfiguration != null) {
			...
			sb.append("\"postFilterConfiguration\": ");

			sb.append(String.valueOf(postFilterConfiguration));
		}
		...
		RescoreConfiguration rescoreConfiguration = getRescoreConfiguration();
		...
		if (rescoreConfiguration != null) {
			...
			sb.append("\"rescoreConfiguration\": ");

			sb.append(String.valueOf(rescoreConfiguration));
		}

		Object scopeConfiguration = getScopeConfiguration();
		...
		if (scopeConfiguration != null) {
			...
			sb.append("\"scopeConfiguration\": ");

			if (scopeConfiguration instanceof Map) {
				sb.append(
					JSONFactoryUtil.createJSONObject(
						(Map<?, ?>)scopeConfiguration));
			}
			else if (scopeConfiguration instanceof String) {
				sb.append("\"");
				sb.append(_escape((String)scopeConfiguration));
				sb.append("\"");
			}
			else {
				sb.append(scopeConfiguration);
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v2_0.Configuration",
		name = "x-class-name"
	)
