 ...
 */
@Generated("")
@GraphQLName("ConditionConfiguration")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ConditionConfiguration")
public class ConditionConfiguration implements Serializable {

	public static ConditionConfiguration toDTO(String json) {
		return ObjectMapperUtil.readValue(ConditionConfiguration.class, json);
	}

	public static ConditionConfiguration unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ConditionConfiguration.class, json);
	}
	...
	@JsonIgnore
	private Supplier<Condition[]> _conditionsSupplier;
	...
	public String toString() {
		...
		if (conditions != null) {
			...
			for (int i = 0; i < conditions.length; i++) {
				sb.append(String.valueOf(conditions[i]));
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v2_0.ConditionConfiguration",
		name = "x-class-name"
	)
