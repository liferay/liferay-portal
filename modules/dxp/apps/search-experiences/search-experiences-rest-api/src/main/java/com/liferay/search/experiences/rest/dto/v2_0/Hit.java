...
public class Hit implements Serializable {
	...
	@Schema
	public String getAssetSearchSummary() {
		if (_assetSearchSummarySupplier != null) {
			assetSearchSummary = _assetSearchSummarySupplier.get();

			_assetSearchSummarySupplier = null;
		}

		return assetSearchSummary;
	}

	public void setAssetSearchSummary(String assetSearchSummary) {
		this.assetSearchSummary = assetSearchSummary;

		_assetSearchSummarySupplier = null;
	}

	@JsonIgnore
	public void setAssetSearchSummary(
		UnsafeSupplier<String, Exception> assetSearchSummaryUnsafeSupplier) {

		_assetSearchSummarySupplier = () -> {
			try {
				return assetSearchSummaryUnsafeSupplier.get();
			}
	...
	protected String assetSearchSummary;

	@JsonIgnore
	private Supplier<String> _assetSearchSummarySupplier;
	...
	public String toString() {
		...
		String assetSearchSummary = getAssetSearchSummary();

		if (assetSearchSummary != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"assetSearchSummary\": ");

			sb.append("\"");

			sb.append(_escape(assetSearchSummary));
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v2_0.Hit",
		name = "x-class-name"
	)
