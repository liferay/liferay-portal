 ...
 */
@Generated("")
@GraphQLName("PostFilterConfiguration")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PostFilterConfiguration")
public class PostFilterConfiguration implements Serializable {

	public static PostFilterConfiguration toDTO(String json) {
		return ObjectMapperUtil.readValue(PostFilterConfiguration.class, json);
	}

	public static PostFilterConfiguration unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			PostFilterConfiguration.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v2_0.PostFilterConfiguration",
		name = "x-class-name"
	)
