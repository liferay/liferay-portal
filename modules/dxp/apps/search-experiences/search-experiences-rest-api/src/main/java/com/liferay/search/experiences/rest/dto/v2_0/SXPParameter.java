 ...
 */
@Generated("")
@GraphQLName("SXPParameter")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SXPParameter")
public class SXPParameter implements Serializable {

	public static SXPParameter toDTO(String json) {
		return ObjectMapperUtil.readValue(SXPParameter.class, json);
	}

	public static SXPParameter unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SXPParameter.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v2_0.SXPParameter",
		name = "x-class-name"
	)
