...
import com.liferay.search.experiences.rest.client.resource.v2_0.SXPBlueprintResource;
...
public abstract class BaseSXPBlueprintResourceTestCase {
	...
	public void testGraphQLGetSXPBlueprintByExternalReferenceCode()
		...
		// Using the namespace searchExperiences_v2_0
						...
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new GraphQLField(
									...
									getGraphQLFields()))),
						"JSONObject/data", "JSONObject/searchExperiences_v2_0",
						"Object/sXPBlueprintByExternalReferenceCode"))));
	}
	...
	protected void assertValid(SXPBlueprint sxpBlueprint) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"collectionProvider", additionalAssertFieldName)) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.search.experiences.rest.dto.v2_0.SXPBlueprint.
						class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						sxpBlueprint1.getCollectionProvider(),
						sxpBlueprint2.getCollectionProvider())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("collectionProvider")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
	...
	protected SXPBlueprint randomSXPBlueprint() throws Exception {
		return new SXPBlueprint() {
			{
				collectionProvider = RandomTestUtil.randomBoolean();
	...
	@Inject
	private
		com.liferay.search.experiences.rest.resource.v2_0.SXPBlueprintResource
