...
public class PatcherProjectVersionLocalServiceUtil {
	...
	public static PatcherProjectVersion addPatcherProjectVersion(
			...
			long rootPatcherProjectVersionId, String name,
			boolean combinedBranch, boolean hide, String committish,
			String repositoryName, String fixedIssues)
		throws PortalException {

		return getService().addPatcherProjectVersion(
			userId, patcherProductVersionId, rootPatcherProjectVersionId, name,
			combinedBranch, hide, committish, repositoryName, fixedIssues);
	}
	...
	public static PatcherProjectVersion updatePatcherProjectVersion(
			...
			String name, boolean combinedBranch, boolean hide,
			String committish, String repositoryName, String fixedIssues)
		throws PortalException {

		return getService().updatePatcherProjectVersion(
			patcherProjectVersionId, patcherProductVersionId, name,
			combinedBranch, hide, committish, repositoryName, fixedIssues);
	}
