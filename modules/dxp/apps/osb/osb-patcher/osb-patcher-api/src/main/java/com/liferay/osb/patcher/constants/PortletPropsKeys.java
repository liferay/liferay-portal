...
public class PortletPropsKeys {
	...
	public static final String JENKINS_BUILD_WITH_PARAMETERS_PATH =
		"jenkins.build.with.parameters.path";

	public static final String JENKINS_LOAD_BALANCER_BASE_INVOCATION_URL =
		"jenkins.load.balancer.base.invocation.url";

	public static final String JENKINS_LOAD_BALANCER_ENABLED =
		"jenkins.load.balancer.enabled";
