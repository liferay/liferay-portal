...
/**
 * The base model interface for the PatcherBuild service. Represents a row in the &quot;PatcherBuild&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public interface PatcherBuildModel
	extends AuditedModel, BaseModel<PatcherBuild>, ShardedModel,
			WorkflowedModel {
