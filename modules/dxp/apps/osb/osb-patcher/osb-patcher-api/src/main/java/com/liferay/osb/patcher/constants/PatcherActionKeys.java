...
public class PatcherActionKeys {
	...
	public static final String EDIT_COMMENTS_FIELD = "EDIT_COMMENTS_FIELD";

	public static final String EDIT_FIX_PACK_FIELDS = "EDIT_FIX_PACK_FIELDS";

	public static final String EDIT_QA_FIELDS = "EDIT_QA_FIELDS";
