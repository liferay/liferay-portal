 ...
 * @generated
 */
public class PatcherProjectVersionCacheModel implements CacheModel<PatcherProjectVersion>,
	Externalizable {
	@Override
	...
	public PatcherProjectVersion toEntityModel() {
		...
		patcherProjectVersionImpl.setPatcherProjectVersionId(patcherProjectVersionId);
		patcherProjectVersionImpl.setCompanyId(companyId);
		patcherProjectVersionImpl.setUserId(userId);

		if (userName == null) {
			patcherProjectVersionImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		patcherProjectVersionImpl.setPatcherProductVersionId(patcherProductVersionId);
		patcherProjectVersionImpl.setRootPatcherProjectVersionId(rootPatcherProjectVersionId);

		if (name == null) {
			patcherProjectVersionImpl.setName(StringPool.BLANK);
		}
		else {
		...
		if (committish == null) {
			patcherProjectVersionImpl.setCommittish(StringPool.BLANK);
		}
		else {
		...
		if (repositoryName == null) {
			patcherProjectVersionImpl.setRepositoryName(StringPool.BLANK);
		}
		else {
		...
		if (fixedIssues == null) {
			patcherProjectVersionImpl.setFixedIssues(StringPool.BLANK);
		}
		else {
