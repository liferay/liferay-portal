...
public class PatcherBuildPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPatcherBuild.setOriginalName(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingPatcherBuild.getOriginalName(),
			newPatcherBuild.getOriginalName());
		Assert.assertEquals(
	...
	protected OrderByComparator<PatcherBuild> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"PatcherBuild", "patcherBuildId", true, "companyId", true, "userId",
			true, "userName", true, "createDate", true, "modifiedDate", true,
			"patcherAccountId", true, "patcherFixId", true,
			"patcherProductVersionId", true, "patcherProjectVersionId", true,
			"ticketEntryId", true, "hotfixId", true, "name", true,
			"originalName", true, "key", true, "keyVersion", true, "type", true,
			"latestBuild", true, "latestKeyBuild", true,
	...
	protected PatcherBuild addPatcherBuild() throws Exception {
		...
		patcherBuild.setOriginalName(RandomTestUtil.randomString());
