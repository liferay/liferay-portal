...
public class PatcherFixPackPersistenceTest {
	...
	protected OrderByComparator<PatcherFixPack> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"PatcherFixPack", "patcherFixPackId", true, "companyId", true,
			"userId", true, "userName", true, "createDate", true,
			"modifiedDate", true, "patcherBuildId", true,
			"patcherFixComponentId", true, "patcherProjectVersionId", true,
			"name", true, "version", true, "releasedDate", true, "requirements",
			true, "status", true);
	}
