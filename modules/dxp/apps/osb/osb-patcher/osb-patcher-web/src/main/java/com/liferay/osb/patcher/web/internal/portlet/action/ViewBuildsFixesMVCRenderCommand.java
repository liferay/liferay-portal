...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/view_builds_fixes"
	},
	service = MVCRenderCommand.class
)
public class ViewBuildsFixesMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		return "/osb_patcher/views/fixes/builds.jsp";
	}
