...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/update_fix_components"
	},
	service = MVCActionCommand.class
)
public class UpdateFixComponentsMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		_patcherFixComponentLocalService.updatePatcherFixComponent(
