...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/edit_comments_field_fixes"
	},
	service = MVCRenderCommand.class
)
public class EditCommentsFieldFixesMVCRenderCommand
	...
	public String render(
		...
		return "/osb_patcher/views/fixes/edit_comments_field.jsp";
	}
