...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/update_product_versions"
	},
	service = MVCActionCommand.class
)
public class UpdateProductVersionsMVCActionCommand
	...
	protected void doProcessAction(
		...
		_patcherProductVersionLocalService.updatePatcherProductVersion(
