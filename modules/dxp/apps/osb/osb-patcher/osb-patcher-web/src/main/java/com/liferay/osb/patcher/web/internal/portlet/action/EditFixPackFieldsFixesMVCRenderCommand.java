...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/edit_fix_pack_fields_fixes"
	},
	service = MVCRenderCommand.class
)
public class EditFixPackFieldsFixesMVCRenderCommand
	...
	public String render(
		...
		try {
			...
			if (!PatcherPermission.contains(
					...
					PatcherActionKeys.EDIT_FIX_PACK_FIELDS,
		...
		return "/osb_patcher/views/fixes/edit_fix_pack_fields.jsp";
	}
