...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/delete_fixes"
	},
	service = MVCActionCommand.class
)
public class DeleteFixesMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		_patcherFixLocalService.deletePatcherFix(patcherFixId);
	}
