...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/edit_fix_components"
	},
	service = MVCRenderCommand.class
)
public class EditFixComponentsMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		long patcherFixComponentId = ParamUtil.getLong(
			renderRequest, "patcherFixComponentId");
		...
		try {
			...
			if (!PatcherPermission.contains(
					themeDisplay.getPermissionChecker(), patcherFixComponent,
		...
		return "/osb_patcher/views/fix_components/edit.jsp";
	}
