...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/view_fixes_builds"
	},
	service = MVCRenderCommand.class
)
public class ViewFixesBuildsMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		return "/osb_patcher/views/builds/fixes.jsp";
	}
