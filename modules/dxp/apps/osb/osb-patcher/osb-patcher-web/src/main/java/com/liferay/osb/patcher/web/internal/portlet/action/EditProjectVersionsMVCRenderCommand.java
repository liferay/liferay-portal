...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/edit_project_versions"
	},
	service = MVCRenderCommand.class
)
public class EditProjectVersionsMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		try {
			...
			if (!PatcherPermission.contains(
					themeDisplay.getPermissionChecker(), patcherProjectVersion,
					PatcherActionKeys.EDIT,
					patcherProjectVersion.getUserId())) {
		...
		return "/osb_patcher/views/project_versions/edit.jsp";
	}
