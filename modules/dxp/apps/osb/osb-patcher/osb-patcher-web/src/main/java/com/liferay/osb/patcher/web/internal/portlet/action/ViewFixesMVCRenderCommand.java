...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/view_fixes"
	},
	service = MVCRenderCommand.class
)
public class ViewFixesMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		try {
			...
			if (!PatcherPermission.contains(
					themeDisplay.getPermissionChecker(), patcherFix, "VIEW",
		...
		return "/osb_patcher/views/fixes/view.jsp";
	}
