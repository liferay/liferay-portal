...
@Component(
	property = {
		...
		"mvc.command.name=/patcher/view_fixes_fixes"
	},
	service = MVCRenderCommand.class
)
public class ViewFixesFixesMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		return "/osb_patcher/views/fixes/fixes.jsp";
	}
