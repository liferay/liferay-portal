...
public class PatcherProjectVersionPersistenceImpl
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {patcherProjectVersionModelImpl.getName()};

		finderCache.putResult(
			_finderPathFetchByName, args, patcherProjectVersionModelImpl);

		args = new Object[] {patcherProjectVersionModelImpl.getCommittish()};
	...
	private static final String _FILTER_SQL_SELECT_PATCHERPROJECTVERSION_WHERE =
		"SELECT DISTINCT {patcherProjectVersion.*} FROM PatcherProjectVersion patcherProjectVersion WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERPROJECTVERSION_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {PatcherProjectVersion.*} FROM (SELECT DISTINCT patcherProjectVersion.patcherProjectVersionId FROM PatcherProjectVersion patcherProjectVersion WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERPROJECTVERSION_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN PatcherProjectVersion ON TEMP_TABLE.patcherProjectVersionId = PatcherProjectVersion.patcherProjectVersionId";

	private static final String _FILTER_SQL_COUNT_PATCHERPROJECTVERSION_WHERE =
		"SELECT COUNT(DISTINCT patcherProjectVersion.patcherProjectVersionId) AS COUNT_VALUE FROM PatcherProjectVersion patcherProjectVersion WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "patcherProjectVersion";

	private static final String _FILTER_ENTITY_TABLE = "PatcherProjectVersion";
