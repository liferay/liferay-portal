...
public class PatcherFixPackPersistenceImpl
	...
	public void activate() {
		...
		patcherFixPackToPatcherFixTableMapper =
			TableMapperFactory.getTableMapper(
				"PatcherFixes_PatcherFixPacks#patcherFixPackId",
				"PatcherFixes_PatcherFixPacks", "companyId", "patcherFixPackId",
	...
	private static final String _FILTER_SQL_SELECT_PATCHERFIXPACK_WHERE =
		"SELECT DISTINCT {patcherFixPack.*} FROM PatcherFixPack patcherFixPack WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERFIXPACK_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {PatcherFixPack.*} FROM (SELECT DISTINCT patcherFixPack.patcherFixPackId FROM PatcherFixPack patcherFixPack WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERFIXPACK_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN PatcherFixPack ON TEMP_TABLE.patcherFixPackId = PatcherFixPack.patcherFixPackId";

	private static final String _FILTER_SQL_COUNT_PATCHERFIXPACK_WHERE =
		"SELECT COUNT(DISTINCT patcherFixPack.patcherFixPackId) AS COUNT_VALUE FROM PatcherFixPack patcherFixPack WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "patcherFixPack";

	private static final String _FILTER_ENTITY_TABLE = "PatcherFixPack";

	private static final String _ORDER_BY_ENTITY_ALIAS = "patcherFixPack.";

	private static final String _ORDER_BY_ENTITY_TABLE = "PatcherFixPack.";
