...
/**
 * The base model implementation for the PatcherFix service. Represents a row in the &quot;PatcherFix&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PatcherFixModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "PatcherFix";

	public static final Object[][] TABLE_COLUMNS = {
		{"patcherFixId", Types.BIGINT}, {"companyId", Types.BIGINT},
	...
	static {
		...
		columnBitmasks.put("patcherFixId", 1L);
		...
		columnBitmasks.put("patcherProjectVersionId", 128L);

		columnBitmasks.put("name", 256L);

		columnBitmasks.put("key_", 512L);

		columnBitmasks.put("keyVersion", 1024L);

		columnBitmasks.put("type_", 2048L);

		columnBitmasks.put("latestFix", 4096L);

		columnBitmasks.put("obsolete", 8192L);

		columnBitmasks.put("committish", 16384L);

		columnBitmasks.put("gitHash", 32768L);

		columnBitmasks.put("gitRemoteURL", 65536L);

		columnBitmasks.put("dependencies", 131072L);

		columnBitmasks.put("requirements", 262144L);

		columnBitmasks.put("requestKey", 524288L);

		columnBitmasks.put("jenkinsResults", 1048576L);

		columnBitmasks.put("comments", 2097152L);

		columnBitmasks.put("fixPackStatus", 4194304L);

		columnBitmasks.put("notified", 8388608L);

		columnBitmasks.put("productVersion", 16777216L);
