...
import com.liferay.osb.patcher.service.persistence.impl.constants.OSBPersistenceConstants;
...
public class PatcherBuildPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByP_NotP_NotT_C;
	private FinderPath _finderPathWithPaginationCountByP_NotP_NotT_C;
	 ...
	 */
	@Override
	public List<PatcherBuild> findByP_NotP_NotT_C(
		long patcherFixId, long patcherProductVersionId, int type,
		boolean childBuild) {

		return findByP_NotP_NotT_C(
	...
	public List<PatcherBuild> findByP_NotP_NotT_C(
		...
		finderPath = _finderPathWithPaginationFindByP_NotP_NotT_C;
		finderArgs = new Object[] {
			patcherFixId, patcherProductVersionId, type, childBuild, start, end,
			orderByComparator
		};
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_P_NOTP_NOTT_C_PATCHERFIXID_2);

			sb.append(_FINDER_COLUMN_P_NOTP_NOTT_C_PATCHERPRODUCTVERSIONID_2);

			sb.append(_FINDER_COLUMN_P_NOTP_NOTT_C_TYPE_2);

			sb.append(_FINDER_COLUMN_P_NOTP_NOTT_C_CHILDBUILD_2);
	 ...
	 */
	@Override
	public PatcherBuild findByP_NotP_NotT_C_First(
			long patcherFixId, long patcherProductVersionId, int type,
			boolean childBuild,
			OrderByComparator<PatcherBuild> orderByComparator)
		throws NoSuchPatcherBuildException {

		PatcherBuild patcherBuild = fetchByP_NotP_NotT_C_First(
			patcherFixId, patcherProductVersionId, type, childBuild,
			orderByComparator);
	 ...
	 */
	@Override
	public PatcherBuild fetchByP_NotP_NotT_C_First(
		long patcherFixId, long patcherProductVersionId, int type,
		boolean childBuild, OrderByComparator<PatcherBuild> orderByComparator) {

		List<PatcherBuild> list = findByP_NotP_NotT_C(
			patcherFixId, patcherProductVersionId, type, childBuild, 0, 1,
			orderByComparator);
	 ...
	 */
	@Override
	public PatcherBuild findByP_NotP_NotT_C_Last(
			long patcherFixId, long patcherProductVersionId, int type,
			boolean childBuild,
			OrderByComparator<PatcherBuild> orderByComparator)
		throws NoSuchPatcherBuildException {

		PatcherBuild patcherBuild = fetchByP_NotP_NotT_C_Last(
			patcherFixId, patcherProductVersionId, type, childBuild,
			orderByComparator);
	 ...
	 */
	@Override
	public PatcherBuild fetchByP_NotP_NotT_C_Last(
		long patcherFixId, long patcherProductVersionId, int type,
		boolean childBuild, OrderByComparator<PatcherBuild> orderByComparator) {

		int count = countByP_NotP_NotT_C(
			patcherFixId, patcherProductVersionId, type, childBuild);
		...
		List<PatcherBuild> list = findByP_NotP_NotT_C(
			patcherFixId, patcherProductVersionId, type, childBuild, count - 1,
	 ...
	 */
	@Override
	public PatcherBuild[] findByP_NotP_NotT_C_PrevAndNext(
			long patcherBuildId, long patcherFixId,
		...
		try {
			...
			array[0] = getByP_NotP_NotT_C_PrevAndNext(
				session, patcherBuild, patcherFixId, patcherProductVersionId,
				type, childBuild, orderByComparator, true);

			array[1] = patcherBuild;

			array[2] = getByP_NotP_NotT_C_PrevAndNext(
				session, patcherBuild, patcherFixId, patcherProductVersionId,
				type, childBuild, orderByComparator, false);
	...
	protected PatcherBuild getByP_NotP_NotT_C_PrevAndNext(
		Session session, PatcherBuild patcherBuild, long patcherFixId,
		long patcherProductVersionId, int type, boolean childBuild,
		OrderByComparator<PatcherBuild> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<PatcherBuild> filterFindByP_NotP_NotT_C(
		long patcherFixId, long patcherProductVersionId, int type,
		boolean childBuild) {

		return filterFindByP_NotP_NotT_C(
			patcherFixId, patcherProductVersionId, type, childBuild,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<PatcherBuild> filterFindByP_NotP_NotT_C(
		...
		sb.append(_FINDER_COLUMN_P_NOTP_NOTT_C_TYPE_2_SQL);
	 ...
	 */
	@Override
	public PatcherBuild[] filterFindByP_NotP_NotT_C_PrevAndNext(
			long patcherBuildId, long patcherFixId,
			long patcherProductVersionId, int type, boolean childBuild,
			OrderByComparator<PatcherBuild> orderByComparator)
		throws NoSuchPatcherBuildException {
		...
		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByP_NotP_NotT_C_PrevAndNext(
		...
		try {
			...
			array[0] = filterGetByP_NotP_NotT_C_PrevAndNext(
				session, patcherBuild, patcherFixId, patcherProductVersionId,
				type, childBuild, orderByComparator, true);

			array[1] = patcherBuild;

			array[2] = filterGetByP_NotP_NotT_C_PrevAndNext(
				session, patcherBuild, patcherFixId, patcherProductVersionId,
				type, childBuild, orderByComparator, false);
	...
	protected PatcherBuild filterGetByP_NotP_NotT_C_PrevAndNext(
		Session session, PatcherBuild patcherBuild, long patcherFixId,
		long patcherProductVersionId, int type, boolean childBuild,
		OrderByComparator<PatcherBuild> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByP_NotP_NotT_C(
		long patcherFixId, long patcherProductVersionId, int type,
		boolean childBuild) {
	 ...
	 */
	@Override
	public int countByP_NotP_NotT_C(
		long patcherFixId, long patcherProductVersionId, int type,
		boolean childBuild) {

		FinderPath finderPath = _finderPathWithPaginationCountByP_NotP_NotT_C;
	 ...
	 */
	@Override
	public int filterCountByP_NotP_NotT_C(
		long patcherFixId, long patcherProductVersionId, int type,
		boolean childBuild) {

		if (!InlineSQLHelperUtil.isEnabled()) {
			return countByP_NotP_NotT_C(
				patcherFixId, patcherProductVersionId, type, childBuild);
		}
	...
	private static final String _FINDER_COLUMN_P_NOTP_NOTT_C_PATCHERFIXID_2 =
		"patcherBuild.patcherFixId = ? AND ";

	private static final String
		_FINDER_COLUMN_P_NOTP_NOTT_C_PATCHERPRODUCTVERSIONID_2 =
			"patcherBuild.patcherProductVersionId != ? AND ";

	private static final String _FINDER_COLUMN_P_NOTP_NOTT_C_TYPE_2 =
		"patcherBuild.type != ? AND ";

	private static final String _FINDER_COLUMN_P_NOTP_NOTT_C_TYPE_2_SQL =
		"patcherBuild.type_ != ? AND ";

	private static final String _FINDER_COLUMN_P_NOTP_NOTT_C_CHILDBUILD_2 =
		"patcherBuild.childBuild = ?";
	...
	public List<PatcherBuild> findByP_N_L_A(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {
					patcherProjectVersionId, name, latestKeyBuild,
					accountEntryCode
				};
			}
		}
	...
	public PatcherBuild fetchByP_N_L_A_First(
		...
		List<PatcherBuild> list = findByP_N_L_A(
			patcherProjectVersionId, name, latestKeyBuild, accountEntryCode, 0,
			1, orderByComparator);
	...
	public PatcherBuild[] findByP_N_L_A_PrevAndNext(
		...
		try {
			...
			array[0] = getByP_N_L_A_PrevAndNext(
				session, patcherBuild, patcherProjectVersionId, name,
				latestKeyBuild, accountEntryCode, orderByComparator, true);

			array[1] = patcherBuild;

			array[2] = getByP_N_L_A_PrevAndNext(
				session, patcherBuild, patcherProjectVersionId, name,
				latestKeyBuild, accountEntryCode, orderByComparator, false);
	...
	public void removeByP_N_L_A(
		...
		for (PatcherBuild patcherBuild :
				findByP_N_L_A(
					patcherProjectVersionId, name, latestKeyBuild,
					accountEntryCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	private static final String _FINDER_COLUMN_P_N_L_A_NAME_2 =
		"CAST_CLOB_TEXT(patcherBuild.name) = ? AND ";

	private static final String _FINDER_COLUMN_P_N_L_A_NAME_3 =
		"(patcherBuild.name IS NULL OR CAST_CLOB_TEXT(patcherBuild.name) = '') AND ";
	...
	private static final String _FINDER_COLUMN_P_N_L_A_ACCOUNTENTRYCODE_3 =
		"(patcherBuild.accountEntryCode IS NULL OR patcherBuild.accountEntryCode = '')";
	...
	public void activate() {
		...
		patcherBuildToPatcherAccountTableMapper =
			TableMapperFactory.getTableMapper(
				"PatcherAccounts_PatcherBuilds#patcherBuildId",
				"PatcherAccounts_PatcherBuilds", "companyId", "patcherBuildId",
				"patcherAccountId", this, PatcherAccount.class);

		patcherBuildToPatcherFixTableMapper = TableMapperFactory.getTableMapper(
			"PatcherBuilds_PatcherFixes#patcherBuildId",
			"PatcherBuilds_PatcherFixes", "companyId", "patcherBuildId",
		...
		_finderPathWithPaginationFindByP_NotP_NotT_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByP_NotP_NotT_C",
			new String[] {
				Long.class.getName(), Long.class.getName(),
			...
			new String[] {
				"patcherFixId", "patcherProductVersionId", "type_", "childBuild"
			},
			true);

		_finderPathWithPaginationCountByP_NotP_NotT_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByP_NotP_NotT_C",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Boolean.class.getName()
			},
	...
	@Override
	@Reference(
		target = OSBPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = OSBPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static final String _FILTER_SQL_SELECT_PATCHERBUILD_WHERE =
		"SELECT DISTINCT {patcherBuild.*} FROM PatcherBuild patcherBuild WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERBUILD_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {PatcherBuild.*} FROM (SELECT DISTINCT patcherBuild.patcherBuildId FROM PatcherBuild patcherBuild WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERBUILD_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN PatcherBuild ON TEMP_TABLE.patcherBuildId = PatcherBuild.patcherBuildId";

	private static final String _FILTER_SQL_COUNT_PATCHERBUILD_WHERE =
		"SELECT COUNT(DISTINCT patcherBuild.patcherBuildId) AS COUNT_VALUE FROM PatcherBuild patcherBuild WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "patcherBuild";

	private static final String _FILTER_ENTITY_TABLE = "PatcherBuild";

	private static final String _ORDER_BY_ENTITY_ALIAS = "patcherBuild.";

	private static final String _ORDER_BY_ENTITY_TABLE = "PatcherBuild.";
