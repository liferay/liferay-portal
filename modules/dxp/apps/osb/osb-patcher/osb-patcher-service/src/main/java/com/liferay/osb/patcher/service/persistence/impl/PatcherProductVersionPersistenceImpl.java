...
public class PatcherProductVersionPersistenceImpl
	...
	private static final String _FILTER_SQL_SELECT_PATCHERPRODUCTVERSION_WHERE =
		"SELECT DISTINCT {patcherProductVersion.*} FROM PatcherProductVersion patcherProductVersion WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERPRODUCTVERSION_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {PatcherProductVersion.*} FROM (SELECT DISTINCT patcherProductVersion.patcherProductVersionId FROM PatcherProductVersion patcherProductVersion WHERE ";

	private static final String
		_FILTER_SQL_SELECT_PATCHERPRODUCTVERSION_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN PatcherProductVersion ON TEMP_TABLE.patcherProductVersionId = PatcherProductVersion.patcherProductVersionId";

	private static final String _FILTER_SQL_COUNT_PATCHERPRODUCTVERSION_WHERE =
		"SELECT COUNT(DISTINCT patcherProductVersion.patcherProductVersionId) AS COUNT_VALUE FROM PatcherProductVersion patcherProductVersion WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "patcherProductVersion";

	private static final String _FILTER_ENTITY_TABLE = "PatcherProductVersion";
