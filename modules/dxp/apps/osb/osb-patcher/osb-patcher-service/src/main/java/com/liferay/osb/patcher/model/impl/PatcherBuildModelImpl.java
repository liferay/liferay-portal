...
/**
 * The base model implementation for the PatcherBuild service. Represents a row in the &quot;PatcherBuild&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PatcherBuildModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "PatcherBuild";

	public static final Object[][] TABLE_COLUMNS = {
		{"patcherBuildId", Types.BIGINT}, {"companyId", Types.BIGINT},
	...
	public static final String
		MAPPING_TABLE_PATCHERACCOUNTS_PATCHERBUILDS_NAME =
			"PatcherAccounts_PatcherBuilds";

	public static final Object[][]
		MAPPING_TABLE_PATCHERACCOUNTS_PATCHERBUILDS_COLUMNS = {
			{"companyId", Types.BIGINT}, {"patcherAccountId", Types.BIGINT},
			{"patcherBuildId", Types.BIGINT}
		};

	public static final String
		MAPPING_TABLE_PATCHERACCOUNTS_PATCHERBUILDS_SQL_CREATE =
			"create table PatcherAccounts_PatcherBuilds (companyId LONG not null,patcherAccountId LONG not null,patcherBuildId LONG not null,primary key (patcherAccountId, patcherBuildId))";

	public static final String MAPPING_TABLE_PATCHERBUILDS_PATCHERFIXES_NAME =
		"PatcherBuilds_PatcherFixes";

	public static final Object[][]
		MAPPING_TABLE_PATCHERBUILDS_PATCHERFIXES_COLUMNS = {
			{"companyId", Types.BIGINT}, {"patcherBuildId", Types.BIGINT},
			{"patcherFixId", Types.BIGINT}
		};

	public static final String
		MAPPING_TABLE_PATCHERBUILDS_PATCHERFIXES_SQL_CREATE =
			"create table PatcherBuilds_PatcherFixes (companyId LONG not null,patcherBuildId LONG not null,patcherFixId LONG not null,primary key (patcherBuildId, patcherFixId))";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"originalName", PatcherBuild::getOriginalName);
	...
	public PatcherBuild cloneWithOriginalValues() {
		...
		patcherBuildImpl.setOriginalName(
			this.<String>getColumnOriginalValue("originalName"));
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("originalName", _originalName);
	...
	static {
		...
		columnBitmasks.put("patcherBuildId", 1L);
		...
		columnBitmasks.put("patcherAccountId", 64L);

		columnBitmasks.put("patcherFixId", 128L);

		columnBitmasks.put("patcherProductVersionId", 256L);

		columnBitmasks.put("patcherProjectVersionId", 512L);

		columnBitmasks.put("ticketEntryId", 1024L);

		columnBitmasks.put("hotfixId", 2048L);

		columnBitmasks.put("name", 4096L);

		columnBitmasks.put("originalName", 8192L);

		columnBitmasks.put("key_", 16384L);

		columnBitmasks.put("keyVersion", 32768L);

		columnBitmasks.put("type_", 65536L);

		columnBitmasks.put("latestBuild", 131072L);

		columnBitmasks.put("latestKeyBuild", 262144L);

		columnBitmasks.put("latestLESATicketBuild", 524288L);

		columnBitmasks.put("latestSupportTicketBuild", 1048576L);

		columnBitmasks.put("accountEntryCode", 2097152L);

		columnBitmasks.put("lesaTicket", 4194304L);

		columnBitmasks.put("lesaTicketVersion", 8388608L);

		columnBitmasks.put("supportTicket", 16777216L);

		columnBitmasks.put("supportTicketVersion", 33554432L);

		columnBitmasks.put("fileName", 67108864L);

		columnBitmasks.put("sourceName", 134217728L);

		columnBitmasks.put("childBuild", 268435456L);

		columnBitmasks.put("comments", 536870912L);

		columnBitmasks.put("qaComments", 1073741824L);

		columnBitmasks.put("qaStatus", 2147483648L);

		columnBitmasks.put("requestKey", 4294967296L);

		columnBitmasks.put("notified", 8589934592L);

		columnBitmasks.put("productVersion", 17179869184L);

		columnBitmasks.put("status", 34359738368L);

		columnBitmasks.put("statusByUserId", 68719476736L);

		columnBitmasks.put("statusByUserName", 137438953472L);

		columnBitmasks.put("statusDate", 274877906944L);
