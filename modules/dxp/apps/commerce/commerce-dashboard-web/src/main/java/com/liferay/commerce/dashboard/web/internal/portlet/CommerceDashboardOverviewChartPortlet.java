...
@Component(
	property = {
		...
		"jakarta.portlet.display-name=Commerce Dashboard Overview Chart",
		"jakarta.portlet.expiration-cache=0",
		"jakarta.portlet.init-param.view-template=/overview.jsp",
		"jakarta.portlet.name=" + CommerceDashboardPortletKeys.COMMERCE_DASHBOARD_OVERVIEW_CHART,
