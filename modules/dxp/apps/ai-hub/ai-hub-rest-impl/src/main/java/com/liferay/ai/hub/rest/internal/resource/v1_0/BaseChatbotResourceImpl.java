...
public abstract class BaseChatbotResourceImpl implements ChatbotResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/ai-hub/v1.0/chatbots/by-external-reference-code/{externalReferenceCode}'  -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/chatbots/by-external-reference-code/{externalReferenceCode}"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1680439184