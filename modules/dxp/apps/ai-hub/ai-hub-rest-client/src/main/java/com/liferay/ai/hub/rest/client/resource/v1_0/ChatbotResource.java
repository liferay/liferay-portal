...
public interface ChatbotResource {
	...
	public HttpInvoker.HttpResponse
			getChatbotByExternalReferenceCodeHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public static class ChatbotResourceImpl implements ChatbotResource {
		...
		public Chatbot getChatbotByExternalReferenceCode(
			...
			try {
				return com.liferay.ai.hub.rest.client.serdes.v1_0.ChatbotSerDes.
					toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/ai-hub/v1.0/chatbots/by-external-reference-code/{externalReferenceCode}");
...
// LIFERAY-REST-BUILDER-HASH:438387845