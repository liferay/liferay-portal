 ...
 */
@Generated("")
@GraphQLName("TagsList")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TagsList")
public class TagsList implements Serializable {

	public static TagsList toDTO(String json) {
		return ObjectMapperUtil.readValue(TagsList.class, json);
	}

	public static TagsList unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(TagsList.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.ai.hub.rest.dto.v1_0.TagsList",
		name = "x-class-name"
	)
