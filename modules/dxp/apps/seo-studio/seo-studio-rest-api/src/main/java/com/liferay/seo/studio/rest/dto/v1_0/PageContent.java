 ...
 */
@Generated("")
@GraphQLName("PageContent")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PageContent")
public class PageContent implements Serializable {

	public static PageContent toDTO(String json) {
		return ObjectMapperUtil.readValue(PageContent.class, json);
	}

	public static PageContent unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(PageContent.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.seo.studio.rest.dto.v1_0.PageContent",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1123142991