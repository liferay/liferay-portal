	...
	public void testGetCrawlHitsPage() throws Exception {
		...
		if (irrelevantSeoStudioDomainId != null) {
			...
			page = crawledPageResource.getCrawlHitsPage(
				irrelevantSeoStudioDomainId, null);
		...
		page = crawledPageResource.getCrawlHitsPage(seoStudioDomainId, null);
...
// LIFERAY-REST-BUILDER-HASH:2030070709