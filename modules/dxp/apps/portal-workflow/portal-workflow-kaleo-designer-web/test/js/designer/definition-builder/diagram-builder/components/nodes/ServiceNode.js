...
import ServiceNode from '../../../../../../../src/main/resources/META-INF/resources/designer/js/definition-builder/diagram-builder/components/nodes/ServiceNode';
...
describe('The ServiceNode component should', () => {
	let container;
	...
	it('Be rendered with correct icon and default values for label and description, if they are not set', () => {
		...
		const icon = container.querySelector('svg.lexicon-icon-cog');
		...
		expect(label).toHaveTextContent('service');
