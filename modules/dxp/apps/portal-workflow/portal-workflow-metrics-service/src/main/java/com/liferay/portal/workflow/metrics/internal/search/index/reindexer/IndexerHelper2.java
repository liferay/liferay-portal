 ...
 */
@Component(service = IndexerHelper2.class)
public class IndexerHelper2 { //temporary copy for testing
	...
	private static final Log _log = LogFactoryUtil.getLog(IndexerHelper2.class);
