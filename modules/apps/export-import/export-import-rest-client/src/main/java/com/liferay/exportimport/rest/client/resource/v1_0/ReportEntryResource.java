...
public interface ReportEntryResource {
	...
	public Page<ReportEntry> getPublishProcessReportEntriesPage(
			Long publishProcessId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse
			getPublishProcessReportEntriesPageHttpResponse(
				Long publishProcessId, String search, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public void postPublishProcessReportEntriesPageExportBatch(
			Long publishProcessId, String search, String filterString,
			String sortString, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postPublishProcessReportEntriesPageExportBatchHttpResponse(
				Long publishProcessId, String search, String filterString,
				String sortString, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public static class ReportEntryResourceImpl implements ReportEntryResource {
		...
		public Page<ReportEntry> getPublishProcessReportEntriesPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getPublishProcessReportEntriesPageHttpResponse(
					publishProcessId, search, filterString, pagination,
					sortString);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/publish-processes/{publishProcessId}/report-entries");

			httpInvoker.path("publishProcessId", publishProcessId);
		...
		public void postPublishProcessReportEntriesPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postPublishProcessReportEntriesPageExportBatchHttpResponse(
					publishProcessId, search, filterString, sortString,
					callbackURL, contentType, fieldNames);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/publish-processes/{publishProcessId}/report-entries/export-batch");
...
// LIFERAY-REST-BUILDER-HASH:1130450803