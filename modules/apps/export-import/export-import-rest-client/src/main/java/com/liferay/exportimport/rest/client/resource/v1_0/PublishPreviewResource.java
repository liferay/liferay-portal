...
public interface PublishPreviewResource {
	...
	public HttpInvoker.HttpResponse getSitePublishPreviewHttpResponse(
			String siteExternalReferenceCode, String dateRangeType,
			java.util.Date endDate, java.util.Date startDate)
		throws Exception;
	...
	public static class Builder {
		...
		public PublishPreviewResource build() {
			return new PublishPreviewResourceImpl(this);
		}
	...
	public static class PublishPreviewResourceImpl
		...
		public PublishPreview getSitePublishPreview(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSitePublishPreviewHttpResponse(
			...
			try {
				return PublishPreviewSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/sites/{siteExternalReferenceCode}/publish-preview");
		...
		private PublishPreviewResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PublishPreviewResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:167706403