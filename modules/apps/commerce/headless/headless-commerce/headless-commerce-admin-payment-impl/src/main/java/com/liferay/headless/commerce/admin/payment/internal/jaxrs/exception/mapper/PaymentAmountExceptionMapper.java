...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Payment.PaymentAmountExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class PaymentAmountExceptionMapper
	extends BaseExceptionMapper<CommercePaymentEntryAmountException> {
