...
public interface PriceEntryResource {
	...
	public HttpInvoker.HttpResponse postPriceEntryHttpResponse(
			PriceEntry priceEntry)
		throws Exception;

	public void postPriceEntryBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postPriceEntryBatchHttpResponse(
	...
	public static class PriceEntryResourceImpl implements PriceEntryResource {
		...
		public PriceEntry postPriceEntry(PriceEntry priceEntry)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = postPriceEntryHttpResponse(
				priceEntry);
		...
		public HttpInvoker.HttpResponse postPriceEntryHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-pricing/v2.0/price-entries");
		...
		public void postPriceEntryBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				postPriceEntryBatchHttpResponse(callbackURL, object);
