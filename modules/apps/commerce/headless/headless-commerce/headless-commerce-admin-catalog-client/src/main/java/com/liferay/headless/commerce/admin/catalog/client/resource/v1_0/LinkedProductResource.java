...
public interface LinkedProductResource {
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeLinkedProductsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/linked-products");
...
// LIFERAY-REST-BUILDER-HASH:-537816375