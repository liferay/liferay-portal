...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.SkuUnitOfMeasureKeyExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class SkuUnitOfMeasureKeyExceptionMapper
	extends BaseExceptionMapper<CPInstanceUnitOfMeasureKeyException> {

	@Override
	protected Problem getProblem(
		CPInstanceUnitOfMeasureKeyException
			cpInstanceUnitOfMeasureKeyException) {

		return new Problem(
			Response.Status.BAD_REQUEST, "Sku unit of measure key is invalid");
	}
