...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.SkuUnitOfMeasureRateExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class SkuUnitOfMeasureRateExceptionMapper
	extends BaseExceptionMapper<CPInstanceUnitOfMeasureRateException> {
	...
	protected Problem getProblem(
		...
		return new Problem(
			Response.Status.BAD_REQUEST, "Sku unit of measure rate is invalid");
	}
