...
import { availablesEmptyStateType, TEmptyState } from './types';
import Button from '@clayui/button';

const DEFAULT_TITLE = Liferay.Language.get('no-results-found');
const DEFAULT_IMAGE = '/states/search_state.svg';
const DEFAULT_DESCRIPTION = Liferay.Language.get('review-your-filters-or-search-and-try-again');
...
const EmptyState: React.FC<EmptyStateProps> = ({
    ...
    return (
        ...
        >
            {states.button && (
                <Button onClick={clearButton} displayType='secondary'>{states.button}</Button>
            )}
