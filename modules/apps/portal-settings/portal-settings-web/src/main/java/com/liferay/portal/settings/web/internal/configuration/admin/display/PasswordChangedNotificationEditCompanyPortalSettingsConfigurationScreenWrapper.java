...
public class
	PasswordChangedNotificationEditCompanyPortalSettingsConfigurationScreenWrapper
		extends ConfigurationScreenWrapper {

	@Override
	protected ConfigurationScreen getConfigurationScreen() {
		return _portalSettingsConfigurationScreenFactory.create(
			new PasswordChangedNotificationEditCompanyPortalSettingsConfigurationScreenContributor());
	}
