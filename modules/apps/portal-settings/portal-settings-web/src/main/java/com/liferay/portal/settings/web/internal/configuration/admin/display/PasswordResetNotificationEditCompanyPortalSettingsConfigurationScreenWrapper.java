...
public class
	PasswordResetNotificationEditCompanyPortalSettingsConfigurationScreenWrapper
		extends ConfigurationScreenWrapper {

	@Override
	protected ConfigurationScreen getConfigurationScreen() {
		return _portalSettingsConfigurationScreenFactory.create(
			new PasswordResetNotificationEditCompanyPortalSettingsConfigurationScreenContributor());
	}
