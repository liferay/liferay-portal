...
public class
	AccountCreatedNotificationEditCompanyPortalSettingsConfigurationScreenWrapper
		extends ConfigurationScreenWrapper {

	@Override
	protected ConfigurationScreen getConfigurationScreen() {
		return _portalSettingsConfigurationScreenFactory.create(
			new AccountCreatedNotificationEditCompanyPortalSettingsConfigurationScreenContributor());
	}
