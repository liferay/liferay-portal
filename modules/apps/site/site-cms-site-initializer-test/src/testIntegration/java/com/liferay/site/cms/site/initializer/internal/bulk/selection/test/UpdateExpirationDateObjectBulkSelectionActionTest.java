...
public class UpdateExpirationDateObjectBulkSelectionActionTest {
	...
	public void testDoExecute() throws Exception {
		...
		_invokeDoExecute(objectEntry, expirationDate);
	...
	@Test
	public void testDoExecuteWithNullExpirationDate() throws Exception {
		Date displayDate = new Date(System.currentTimeMillis() - Time.MINUTE);
		...
		Assert.assertNull(updatedObjectEntry.getExpirationDate());
		Assert.assertEquals(displayDate, updatedObjectEntry.getDisplayDate());
	}

	@Test
	public void testDoExecuteWithPastReviewDate() throws Exception {
		ObjectEntry objectEntry = _addObjectEntry(
	...
	private ObjectEntry _addObjectEntry(Date displayDate, Date expirationDate)
		throws Exception {
	...
	private void _invokeDoExecute(ObjectEntry objectEntry, Date expirationDate)
		throws Exception {

		ReflectionTestUtil.invoke(
			_updateExpirationDateObjectBulkSelectionAction, "doExecute",
	...
	@Inject(
		filter = "component.name=com.liferay.site.cms.site.initializer.internal.bulk.selection.UpdateExpirationDateObjectBulkSelectionAction"
	)
