 ...
 */
@Generated("")
public interface SessionsSiteHistogramMetricResource {
	...
	public static class Builder {
		...
		public SessionsSiteHistogramMetricResource build() {
			return new SessionsSiteHistogramMetricResourceImpl(this);
		}
	...
	public static class SessionsSiteHistogramMetricResourceImpl
		implements SessionsSiteHistogramMetricResource {
		...
		private SessionsSiteHistogramMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SessionsSiteHistogramMetricResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:800112293