...
public class PropertySerDes {
	...
	public static String toJSON(Property property) {
		...
		if (property.getName() != null) {
			...
			sb.append(_escape(property.getName()));
	...
	public static Map<String, String> toMap(Property property) {
		...
		if (property.getName() == null) {
			...
			map.put("name", String.valueOf(property.getName()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "name")) {
				if (jsonParserFieldValue != null) {
					property.setName((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "value")) {
				if (jsonParserFieldValue != null) {
...
// LIFERAY-REST-BUILDER-HASH:-1368778618