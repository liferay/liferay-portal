...
public interface UserSessionResource {
	...
	public UserSessions getUserSession(
	...
	public HttpInvoker.HttpResponse getUserSessionHttpResponse(
			String entityId, String entityType, String[] groupIds,
			String keywords, Integer page, String rangeEnd, Integer rangeKey,
			String rangeStart, Integer size)
		throws Exception;
	...
	public static class UserSessionResourceImpl implements UserSessionResource {
		...
		public UserSessions getUserSession(
			...
			HttpInvoker.HttpResponse httpResponse = getUserSessionHttpResponse(
...
// LIFERAY-REST-BUILDER-HASH:130747137