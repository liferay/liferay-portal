...
public interface DocumentMetricResource {
	...
	public HttpInvoker.HttpResponse getDocumentMetricHttpResponse(
			String[] groupIds, String keywords, String rangeEnd,
			Integer rangeKey, String rangeStart, Integer size,
			String sortColumn, String sortType, Integer start)
		throws Exception;
	...
	public static class DocumentMetricResourceImpl
		...
		public DocumentMetrics getDocumentMetric(
			...
			try {
				return DocumentMetricsSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/document-metrics");
...
// LIFERAY-REST-BUILDER-HASH:-1523714788