 ...
 */
@Generated("")
public interface IdentityActivityResource {
	...
	public HttpInvoker.HttpResponse getIdentityActivityHttpResponse(
			String[] groupIds, String[] includedEventIds, Integer rangeKey)
		throws Exception;
	...
	public static class Builder {
		...
		public IdentityActivityResource build() {
			return new IdentityActivityResourceImpl(this);
		}
	...
	public static class IdentityActivityResourceImpl
		implements IdentityActivityResource {
		...
		public IdentityActivity getIdentityActivity(
			...
			HttpInvoker.HttpResponse httpResponse =
				getIdentityActivityHttpResponse(
		...
		public HttpInvoker.HttpResponse getIdentityActivityHttpResponse(
			...
			if (includedEventIds != null) {
				for (int i = 0; i < includedEventIds.length; i++) {
					httpInvoker.parameter(
						"includedEventIds",
						String.valueOf(includedEventIds[i]));
				}
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/identity-activity");
		...
		private IdentityActivityResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			IdentityActivityResource.class.getName());
