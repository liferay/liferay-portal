...
public class ViewPendingWorkflowsSectionSystemFDSEntry
	...
	public String getAdditionalAPIURLParameters(
		...
		String filterString = StringBundler.concat(
			"status eq ", WorkflowConstants.STATUS_PENDING,
	...
	public String getDescription() {
		return "CMS Pending Workflows Section";
	}
	...
	public String getName() {
		return CMSSiteInitializerFDSNames.PENDING_WORKFLOWS_SECTION;
	}

	@Override
	public String getPropsTransformer() {
		return "{PendingWorkflowsFDSPropsTransformer} from " +
