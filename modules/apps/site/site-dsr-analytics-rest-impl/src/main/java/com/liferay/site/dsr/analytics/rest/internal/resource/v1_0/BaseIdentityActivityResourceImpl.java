...
public abstract class BaseIdentityActivityResourceImpl
	implements IdentityActivityResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/identity-activity'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "IdentityActivity")
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/identity-activity")
	...
	public IdentityActivity getIdentityActivity(
			...
			String[] groupIds,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("includedEventIds")
			String[] includedEventIds,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
