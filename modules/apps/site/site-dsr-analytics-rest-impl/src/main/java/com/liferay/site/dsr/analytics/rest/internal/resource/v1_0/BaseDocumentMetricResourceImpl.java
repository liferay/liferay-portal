...
public abstract class BaseDocumentMetricResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/document-metrics'  -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/document-metrics")
...
// LIFERAY-REST-BUILDER-HASH:-1982321006