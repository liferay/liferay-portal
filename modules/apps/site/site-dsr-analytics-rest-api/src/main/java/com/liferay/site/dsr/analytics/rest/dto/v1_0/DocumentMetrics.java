 ...
 */
@Generated("")
@GraphQLName("DocumentMetrics")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DocumentMetrics")
public class DocumentMetrics implements Serializable {

	public static DocumentMetrics toDTO(String json) {
		return ObjectMapperUtil.readValue(DocumentMetrics.class, json);
	}

	public static DocumentMetrics unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DocumentMetrics.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.site.dsr.analytics.rest.dto.v1_0.DocumentMetrics",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:841404573