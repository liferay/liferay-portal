 ...
 */
@Component(
	properties = "OSGI-INF/liferay/rest/v1_0/depot-scope.properties",
	scope = ServiceScope.PROTOTYPE, service = DepotScopeResource.class
)
public class DepotScopeResourceImpl extends BaseDepotScopeResourceImpl {
