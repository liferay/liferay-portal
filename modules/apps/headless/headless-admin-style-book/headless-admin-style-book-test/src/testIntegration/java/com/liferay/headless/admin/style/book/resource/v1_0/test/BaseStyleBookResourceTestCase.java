...
import com.liferay.headless.admin.style.book.client.http.HttpInvoker;
import com.liferay.headless.admin.style.book.client.pagination.Page;
import com.liferay.headless.admin.style.book.client.pagination.Pagination;
import com.liferay.headless.admin.style.book.client.resource.v1_0.StyleBookResource;
import com.liferay.headless.admin.style.book.client.serdes.v1_0.StyleBookSerDes;
...
public abstract class BaseStyleBookResourceTestCase {
	...
	@Test
	public void testGraphQLDeleteAssetLibraryStyleBook() throws Exception {

		// No namespace

		@SuppressWarnings("PMD.UnusedLocalVariable")
		StyleBook styleBook1 =
			testGraphQLDeleteAssetLibraryStyleBook_addStyleBook();
		...
		Assert.assertTrue(
			JSONUtil.getValueAsBoolean(
						...
						new HashMap<String, Object>() {
							{
								put(
									...
									"\"" +
										testGraphQLDeleteAssetLibraryStyleBook_getAssetLibraryExternalReferenceCode() +
											"\"");
								put(
				...
				"JSONObject/data", "Object/deleteAssetLibraryStyleBook"));

		JSONArray errorsJSONArray1 = JSONUtil.getValueAsJSONArray(
			invokeGraphQLQuery(
				new GraphQLField(
					"assetLibraryStyleBook",
					new HashMap<String, Object>() {
						{
							put(
								"assetLibraryExternalReferenceCode",
		...
		// Using the namespace headlessAdminStyleBook_v1_0
		...
		Assert.assertTrue(
			JSONUtil.getValueAsBoolean(
				...
				"JSONObject/data", "JSONObject/headlessAdminStyleBook_v1_0",
				"Object/deleteAssetLibraryStyleBook"));
	...
	protected StyleBook testGraphQLDeleteAssetLibraryStyleBook_addStyleBook()
		throws Exception {

		return testGraphQLAssetLibraryStyleBook_addStyleBook();
	}
	...
	@Test
	public void testGraphQLDeleteSiteStyleBook() throws Exception {

		// No namespace

		@SuppressWarnings("PMD.UnusedLocalVariable")
		StyleBook styleBook1 = testGraphQLDeleteSiteStyleBook_addStyleBook();
		...
		Assert.assertTrue(
			JSONUtil.getValueAsBoolean(
						...
						new HashMap<String, Object>() {
							{
								put(
									...
									"\"" +
										testGraphQLDeleteSiteStyleBook_getSiteExternalReferenceCode() +
											"\"");
								put(
									"styleBookExternalReferenceCode",
									"\"" +
				...
				"JSONObject/data", "Object/deleteSiteStyleBook"));
		...
		@SuppressWarnings("PMD.UnusedLocalVariable")
		StyleBook styleBook2 = testGraphQLDeleteSiteStyleBook_addStyleBook();
	...
	protected StyleBook testGraphQLDeleteSiteStyleBook_addStyleBook()
		throws Exception {

		return testGraphQLSiteStyleBook_addStyleBook();
	}
	...
	@Test
	public void testGraphQLGetAssetLibraryStyleBook() throws Exception {
		StyleBook styleBook =
			testGraphQLGetAssetLibraryStyleBook_addStyleBook();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put(
											"assetLibraryExternalReferenceCode",
											"\"" +
												testGraphQLGetAssetLibraryStyleBook_getAssetLibraryExternalReferenceCode() +
													"\"");
										put(
											"styleBookExternalReferenceCode",
											"\"" +
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/assetLibraryStyleBook"))));
						...
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new GraphQLField(
									...
									getGraphQLFields()))),
						"JSONObject/data",
						"JSONObject/headlessAdminStyleBook_v1_0",
						"Object/assetLibraryStyleBook"))));
	}
	...
	@Test
	public void testGraphQLGetAssetLibraryStyleBookNotFound() throws Exception {
		String irrelevantStyleBookExternalReferenceCode =
						...
						new HashMap<String, Object>() {
							{
								...
								put(
									"styleBookExternalReferenceCode",
									irrelevantStyleBookExternalReferenceCode);
							}
						},
						getGraphQLFields())),
	...
	protected StyleBook testGraphQLGetAssetLibraryStyleBook_addStyleBook()
		throws Exception {
	...
	@Test
	public void testGraphQLGetSiteStyleBook() throws Exception {
		StyleBook styleBook = testGraphQLGetSiteStyleBook_addStyleBook();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put(
											"siteExternalReferenceCode",
											"\"" +
												testGraphQLGetSiteStyleBook_getSiteExternalReferenceCode() +
													"\"");
										put(
											"styleBookExternalReferenceCode",
											"\"" +
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/styleBook"))));
	...
	protected String testGraphQLGetSiteStyleBook_getSiteExternalReferenceCode()
		throws Exception {
	...
	@Test
	public void testGraphQLGetSiteStyleBookNotFound() throws Exception {
		String irrelevantStyleBookExternalReferenceCode =
			"\"" + RandomTestUtil.randomString() + "\"";
	...
	protected StyleBook testGraphQLGetSiteStyleBook_addStyleBook()
		throws Exception {
	...
	protected Map<String, Map<String, String>>
		...
		createBatchAction.put(
			...
			("http://localhost:" + PortalUtil.getPortalServerPort(false) +
				"/o/headless-admin-style-book/v1.0/sites/{siteExternalReferenceCode}/style-books/batch").
					replace(
						"{siteExternalReferenceCode}",
	...
	@Test
	public void testGraphQLGetSiteStyleBooksPage() throws Exception {
		String siteExternalReferenceCode =
			testGetSiteStyleBooksPage_getSiteExternalReferenceCode();
		...
		JSONObject styleBooksJSONObject = JSONUtil.getValueAsJSONObject(
			invokeGraphQLQuery(graphQLField), "JSONObject/data",
			"JSONObject/styleBooks");

		long totalCount = styleBooksJSONObject.getLong("totalCount");

		StyleBook styleBook1 = testGraphQLSiteStyleBook_addStyleBook(
			siteExternalReferenceCode, randomStyleBook());

		StyleBook styleBook2 = testGraphQLSiteStyleBook_addStyleBook(
			siteExternalReferenceCode, randomStyleBook());

		styleBooksJSONObject = JSONUtil.getValueAsJSONObject(
			invokeGraphQLQuery(graphQLField), "JSONObject/data",
			"JSONObject/styleBooks");

		Assert.assertEquals(
			totalCount + 2, styleBooksJSONObject.getLong("totalCount"));

		assertContains(
			styleBook1,
			Arrays.asList(
				StyleBookSerDes.toDTOs(
					styleBooksJSONObject.getString("items"))));
		assertContains(
			styleBook2,
			Arrays.asList(
				StyleBookSerDes.toDTOs(
		...
		styleBooksJSONObject = JSONUtil.getValueAsJSONObject(
			invokeGraphQLQuery(
				new GraphQLField("headlessAdminStyleBook_v1_0", graphQLField)),
			"JSONObject/data", "JSONObject/headlessAdminStyleBook_v1_0",
			"JSONObject/styleBooks");
	...
	@Test
	public void testGraphQLPostSiteStyleBook() throws Exception {
		StyleBook randomStyleBook = randomStyleBook();

		StyleBook styleBook = testGraphQLSiteStyleBook_addStyleBook(
			testGroup.getExternalReferenceCode(), randomStyleBook);

		Assert.assertTrue(equals(randomStyleBook, styleBook));
	}
	...
	public void testBatchEngineDeleteImportTask() throws Exception {
		StyleBook styleBook1 =
			testBatchEngineDeleteImportTask_addAssetLibraryStyleBook();
		...
		styleBook1 = testBatchEngineDeleteImportTask_addSiteStyleBook();
	...
	protected StyleBook
		...
		return testDeleteAssetLibraryStyleBook_addStyleBook();
	}
	...
	protected void testBatchEngineDeleteImportTask_deleteStyleBook(
		...
		HttpResponse httpResponse =
			importTaskResource.deleteImportTaskHttpResponse(
				"com.liferay.headless.admin.style.book.dto.v1_0.StyleBook",
				null, null, null, null,
				JSONUtil.putAll(
					JSONUtil.put(
	...
	protected StyleBook testGraphQLSiteStyleBook_addStyleBook()
		throws Exception {
	...
	protected StyleBook testGraphQLSiteStyleBook_addStyleBook(
		...
		JSONDeserializer<StyleBook> jsonDeserializer =
			JSONFactoryUtil.createJSONDeserializer();

		StringBuilder sb = new StringBuilder("{");

		for (java.lang.reflect.Field field :
				getDeclaredFields(StyleBook.class)) {

			if (getGraphQLValue(field.get(styleBook)) != null) {
				if (sb.length() > 1) {
					sb.append(", ");
				}
				...
				sb.append(": ");
				sb.append(getGraphQLValue(field.get(styleBook)));
			}
		}
						...
						new HashMap<String, Object>() {
							{
								put(
									"siteExternalReferenceCode",
									"\"" + siteExternalReferenceCode + "\"");
								put("styleBook", sb.toString());
							}
						},
						graphQLFields)),
				"JSONObject/data", "JSONObject/createSiteStyleBook"),
			StyleBook.class);
	}
	...
	@Inject
	private
		com.liferay.headless.admin.style.book.resource.v1_0.StyleBookResource
			_styleBookResource;

}
// LIFERAY-REST-BUILDER-HASH:149463758