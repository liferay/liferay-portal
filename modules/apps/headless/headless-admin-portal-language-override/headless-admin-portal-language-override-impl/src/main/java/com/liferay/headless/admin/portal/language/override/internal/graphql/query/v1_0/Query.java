...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {languageOverrides(filter: ___, page: ___, pageSize: ___, search: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
			...
			languageOverrideResource -> new LanguageOverridePage(
				languageOverrideResource.getLanguageOverridesPage(
					...
					_filterBiFunction.apply(
						languageOverrideResource, filterString),
...
// LIFERAY-REST-BUILDER-HASH:764324282