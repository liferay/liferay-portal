...
public abstract class BaseDatabaseSchemaExportResourceImpl
	implements DatabaseSchemaExportResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/admin-server/v1.0/database-schema-export' -d $'{"exportFilesPath": ___, "fileNames": ___, "reportFileName": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Exports the database schema definition."
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "DatabaseSchemaExport"
			)
		}
	)
	@jakarta.ws.rs.Consumes({"application/json", "application/xml"})
	@jakarta.ws.rs.Path("/database-schema-export")
	@jakarta.ws.rs.POST
