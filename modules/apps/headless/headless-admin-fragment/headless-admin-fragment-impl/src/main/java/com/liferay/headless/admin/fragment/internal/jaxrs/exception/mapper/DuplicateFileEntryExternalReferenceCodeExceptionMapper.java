...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.Fragment.DuplicateFileEntryExternalReferenceCodeExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class DuplicateFileEntryExternalReferenceCodeExceptionMapper
