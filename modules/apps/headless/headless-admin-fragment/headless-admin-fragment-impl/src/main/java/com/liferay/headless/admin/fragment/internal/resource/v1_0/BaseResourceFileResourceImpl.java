...
public abstract class BaseResourceFileResourceImpl
	implements EntityModelResource, ResourceFileResource,
			   VulcanBatchEngineTaskItemDelegate<ResourceFile> {
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
				name = "resourceFileExternalReferenceCode", required = true
			)
		}
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "ResourceFile")}
	)
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/resource-files/{resourceFileExternalReferenceCode}"
	)
	...
	public void deleteSiteResourceFile(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("resourceFileExternalReferenceCode")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/fragment-sets/{fragmentSetExternalReferenceCode}/resource-files"
	)
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteExternalReferenceCode}/resource-files")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/resource-folders/{resourceFolderExternalReferenceCode}/resource-files"
	)
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/resource-files/batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postSiteResourceFileBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				ResourceFile.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/resource-files/export-batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postSiteResourceFilesPageExportBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				ResourceFile.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public void create(
		...
		UnsafeFunction<ResourceFile, ResourceFile, Exception>
			resourceFileUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "UPSERT")) {
			...
			if (StringUtil.equalsIgnoreCase(updateStrategy, "UPDATE")) {
				resourceFileUnsafeFunction = resourceFile -> {
					ResourceFile persistedResourceFile = null;

					if (parameters.containsKey("siteExternalReferenceCode")) {
						persistedResourceFile = putSiteResourceFile(
							(String)parameters.get("siteExternalReferenceCode"),
					...
					return persistedResourceFile;
				};
			}
		}

		if (resourceFileUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ResourceFile");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				resourceFiles, resourceFileUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				resourceFiles, resourceFileUnsafeFunction::apply);
		}
		else {
			for (ResourceFile resourceFile : resourceFiles) {
				resourceFileUnsafeFunction.apply(resourceFile);
			}
		}
	}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<ResourceFile>,
			 UnsafeFunction<ResourceFile, ResourceFile, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ResourceFile>, UnsafeConsumer<ResourceFile, Exception>,
