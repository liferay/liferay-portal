...
public class ResourceFolder implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The external reference code of the resource folder's parent resource folder, used to reference an existing parent. Takes precedence over `parentResourceFolder` when both are set."
	)
...
// LIFERAY-REST-BUILDER-HASH:1855335478