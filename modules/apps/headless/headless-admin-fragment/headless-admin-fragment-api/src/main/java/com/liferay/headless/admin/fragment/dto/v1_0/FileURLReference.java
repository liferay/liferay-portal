...
public class FileURLReference implements Serializable {

	public static FileURLReference toDTO(String json) {
		return ObjectMapperUtil.readValue(FileURLReference.class, json);
	}

	public static FileURLReference unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(FileURLReference.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The Base64 encoded file content. On read, returned only when requested via `nestedFields=fileURLReference.fileBase64`."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "A URL the file can be fetched from. On read, the canonical URL of the stored file. On write, used to download bytes (supports `http://`, `https://` and `lar://`) when `fileBase64` is absent."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.fragment.dto.v1_0.FileURLReference",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:886498785