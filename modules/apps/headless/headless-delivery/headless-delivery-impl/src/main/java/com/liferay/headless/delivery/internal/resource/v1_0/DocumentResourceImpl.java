...
public class DocumentResourceImpl extends BaseDocumentResourceImpl {
	...
	public void update(
		...
		Map<Long, Object> documentsMap = new HashMap<>();
	...
	private MultipartBody _getMultipartBodyFromDocument(
		...
		Map<Long, Object> documentsMap = _documentsMap.get();

		if (documentsMap == null) {
			return null;
		}

		Document document = (Document)documentsMap.get(documentId);
	...
	private static final ThreadLocal<Map<Long, Object>> _documentsMap =
