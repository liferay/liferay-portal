 ...
 */
@Generated("")
public interface LinkReferenceResource {
	...
	public static class Builder {
		...
		public LinkReferenceResource build() {
			return new LinkReferenceResourceImpl(this);
		}
	...
	public static class LinkReferenceResourceImpl
		...
		public Page<LinkReference> getScopeScopeKeyLinksPage(
			...
			try {
				return Page.of(content, LinkReferenceSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private LinkReferenceResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			LinkReferenceResource.class.getName());
