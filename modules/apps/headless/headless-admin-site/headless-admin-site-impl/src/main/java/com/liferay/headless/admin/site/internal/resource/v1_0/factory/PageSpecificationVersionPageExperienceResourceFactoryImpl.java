 ...
 */
@Component(
	property = "resource.locator.key=/headless-admin-site/v1.0/PageSpecificationVersionPageExperience",
	service = PageSpecificationVersionPageExperienceResource.Factory.class
)
@Generated("")
public class PageSpecificationVersionPageExperienceResourceFactoryImpl
	implements PageSpecificationVersionPageExperienceResource.Factory {

	@Override
	public PageSpecificationVersionPageExperienceResource.Builder create() {
		return new PageSpecificationVersionPageExperienceResource.Builder() {

			@Override
			public PageSpecificationVersionPageExperienceResource build() {
				if (_user == null) {
				...
				Function
					<InvocationHandler,
					 PageSpecificationVersionPageExperienceResource>
						pageSpecificationVersionPageExperienceResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_pageSpecificationVersionPageExperienceResourceProxyProviderFunction;

				return pageSpecificationVersionPageExperienceResourceProxyProviderFunction.
					apply(
			...
			@Override
			public PageSpecificationVersionPageExperienceResource.Builder
			...
			@Override
			public PageSpecificationVersionPageExperienceResource.Builder user(
				User user) {
	...
	private static Function
		<InvocationHandler, PageSpecificationVersionPageExperienceResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			PageSpecificationVersionPageExperienceResource.class.
				getClassLoader(),
			PageSpecificationVersionPageExperienceResource.class);

		try {
			Constructor<PageSpecificationVersionPageExperienceResource>
				constructor =
					(Constructor
						<PageSpecificationVersionPageExperienceResource>)
