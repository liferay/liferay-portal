...
public interface PageSpecificationVersionResource {
	...
	public static class Builder {
		...
		public PageSpecificationVersionResource build() {
			return new PageSpecificationVersionResourceImpl(this);
		}
	...
	public static class PageSpecificationVersionResourceImpl
		...
		public PageSpecificationVersion getSiteSitePagePageSpecificationVersion(
			...
			try {
				return PageSpecificationVersionSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public Page<PageSpecificationVersion>
			...
			try {
				return Page.of(content, PageSpecificationVersionSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/{sitePageExternalReferenceCode}/page-specification-versions");
		...
		private static final Logger _logger = Logger.getLogger(
			PageSpecificationVersionResource.class.getName());
