...
@Component(
	...
	property = {
		...
		"jakarta.portlet.display-name=Site Template Settings",
		"jakarta.portlet.expiration-cache=0",
		"jakarta.portlet.init-param.template-path=/META-INF/resources/",
		"jakarta.portlet.init-param.view-template=/edit_layout_set_prototype.jsp",
		"jakarta.portlet.name=" + LayoutSetPrototypePortletKeys.SITE_TEMPLATE_SETTINGS,
