...
public class
	LayoutPageTemplateStructureRelElementVariationAudienceEntryRelTableReferenceDefinitionTest
		...
		_layoutPageTemplateStructureRelElementVariation =
			_layoutPageTemplateStructureRelElementVariationLocalService.
				addOrUpdateLayoutPageTemplateStructureRelElementVariation(
					...
					RandomTestUtil.randomString(),
					new String[] {
						_variationAudiencesEntry.getExternalReferenceCode()
					},
	...
	@DeleteAfterTestRun
	private AudiencesEntry _variationAudiencesEntry;
