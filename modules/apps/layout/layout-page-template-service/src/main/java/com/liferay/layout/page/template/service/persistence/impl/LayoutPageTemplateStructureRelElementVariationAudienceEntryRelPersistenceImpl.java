...
public class
	...
	private CollectionPersistenceFinder
		<LayoutPageTemplateStructureRelElementVariationAudienceEntryRel,
		 NoSuchPageTemplateStructureRelElementVariationAudienceEntryRelException>
			_collectionPersistenceFinderByG_AEERC;
	...
	public List<LayoutPageTemplateStructureRelElementVariationAudienceEntryRel>
		...
		return _collectionPersistenceFinderByG_AEERC.find(
			finderCache, new Object[] {groupId, audienceEntryERC}, start, end,
			orderByComparator, useFinderCache);
	}
	...
	public LayoutPageTemplateStructureRelElementVariationAudienceEntryRel
		...
		return _collectionPersistenceFinderByG_AEERC.findFirst(
			finderCache, new Object[] {groupId, audienceEntryERC},
			orderByComparator);
	}
	...
	public LayoutPageTemplateStructureRelElementVariationAudienceEntryRel
		...
		return _collectionPersistenceFinderByG_AEERC.fetchFirst(
			finderCache, new Object[] {groupId, audienceEntryERC},
			orderByComparator);
	}
	 ...
	 */
	@Override
	public void removeByG_AEERC(long groupId, String audienceEntryERC) {
		_collectionPersistenceFinderByG_AEERC.remove(
			finderCache, new Object[] {groupId, audienceEntryERC});
	}
	 ...
	 */
	@Override
	public int countByG_AEERC(long groupId, String audienceEntryERC) {
		return _collectionPersistenceFinderByG_AEERC.count(
			finderCache, new Object[] {groupId, audienceEntryERC});
	}
	...
	public void activate() {
		...
		_collectionPersistenceFinderByG_AEERC =
			new CollectionPersistenceFinder<>(
				this,
				new FinderPath(
					FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_AEERC",
					new String[] {
						Long.class.getName(), String.class.getName(),
						Integer.class.getName(), Integer.class.getName(),
						OrderByComparator.class.getName()
					},
					new String[] {"groupId", "audienceEntryERC"}, true),
				new FinderPath(
					FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_AEERC",
					new String[] {Long.class.getName(), String.class.getName()},
					new String[] {"groupId", "audienceEntryERC"}, 0, 2, true,
					null),
				new FinderPath(
					FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_AEERC",
					new String[] {Long.class.getName(), String.class.getName()},
					new String[] {"groupId", "audienceEntryERC"}, 0, 2, false,
					null),
				_SQL_SELECT_LAYOUTPAGETEMPLATESTRUCTURERELELEMENTVARIATIONAUDIENCEENTRYREL_WHERE,
				_SQL_COUNT_LAYOUTPAGETEMPLATESTRUCTURERELELEMENTVARIATIONAUDIENCEENTRYREL_WHERE,
				LayoutPageTemplateStructureRelElementVariationAudienceEntryRelModelImpl.ORDER_BY_JPQL,
...
// LIFERAY-SERVICE-BUILDER-HASH:-86122414