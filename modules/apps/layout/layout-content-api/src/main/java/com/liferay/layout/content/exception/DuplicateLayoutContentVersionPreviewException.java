 ...
 */
public class DuplicateLayoutContentVersionPreviewException extends PortalException {
	...
	public DuplicateLayoutContentVersionPreviewException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
