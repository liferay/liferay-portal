 ...
 */
public class NoSuchLayoutContentVersionPreviewException extends NoSuchModelException {
	...
	public NoSuchLayoutContentVersionPreviewException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
