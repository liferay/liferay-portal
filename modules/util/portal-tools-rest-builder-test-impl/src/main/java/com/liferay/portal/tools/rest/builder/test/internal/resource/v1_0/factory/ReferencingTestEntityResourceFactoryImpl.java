 ...
 */
@Component(
	property = "resource.locator.key=/portal-tools-rest-builder-test/v1.0/ReferencingTestEntity",
	service = ReferencingTestEntityResource.Factory.class
)
@Generated("")
public class ReferencingTestEntityResourceFactoryImpl
	implements ReferencingTestEntityResource.Factory {

	@Override
	public ReferencingTestEntityResource.Builder create() {
		return new ReferencingTestEntityResource.Builder() {

			@Override
			public ReferencingTestEntityResource build() {
				if (_user == null) {
					throw new IllegalArgumentException("User is not set");
				}

				Function<InvocationHandler, ReferencingTestEntityResource>
					referencingTestEntityResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_referencingTestEntityResourceProxyProviderFunction;

				return referencingTestEntityResourceProxyProviderFunction.apply(
			...
			@Override
			public ReferencingTestEntityResource.Builder checkPermissions(
			...
			@Override
			public ReferencingTestEntityResource.Builder httpServletRequest(
			...
			@Override
			public ReferencingTestEntityResource.Builder httpServletResponse(
			...
			@Override
			public ReferencingTestEntityResource.Builder preferredLocale(
			...
			@Override
			public ReferencingTestEntityResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ReferencingTestEntityResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ReferencingTestEntityResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ReferencingTestEntityResource.class.getClassLoader(),
			ReferencingTestEntityResource.class);

		try {
			Constructor<ReferencingTestEntityResource> constructor =
				(Constructor<ReferencingTestEntityResource>)
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, ReferencingTestEntityResource>
				_referencingTestEntityResourceProxyProviderFunction =
					_getProxyProviderFunction();
