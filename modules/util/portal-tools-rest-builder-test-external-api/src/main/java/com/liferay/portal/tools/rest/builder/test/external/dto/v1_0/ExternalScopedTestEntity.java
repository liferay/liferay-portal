 ...
 */
@Generated("")
@GraphQLName("ExternalScopedTestEntity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ExternalScopedTestEntity")
public class ExternalScopedTestEntity implements Serializable {

	public static ExternalScopedTestEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(ExternalScopedTestEntity.class, json);
	}

	public static ExternalScopedTestEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ExternalScopedTestEntity.class, json);
	}
