 ...
 */
@Generated("")
@GraphQLName("ExternalChildTestEntity1")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ExternalChildTestEntity1")
public class ExternalChildTestEntity1
	...
	public static ExternalChildTestEntity1 toDTO(String json) {
		return ObjectMapperUtil.readValue(ExternalChildTestEntity1.class, json);
	}

	public static ExternalChildTestEntity1 unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ExternalChildTestEntity1.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema
	public String getExternalProperty() {
		if (_externalPropertySupplier != null) {
			externalProperty = _externalPropertySupplier.get();

			_externalPropertySupplier = null;
		}
	...
	public void setExternalProperty(
		...
		_externalPropertySupplier = () -> {
			try {
				return externalPropertyUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<String> _externalPropertySupplier;
	...
	public String toString() {
		...
		String externalProperty = getExternalProperty();
		...
		if (externalProperty != null) {
			...
			sb.append(_escape(externalProperty));
