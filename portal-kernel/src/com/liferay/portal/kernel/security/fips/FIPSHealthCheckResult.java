...
public class FIPSHealthCheckResult {
	...
	public static FIPSHealthCheckResult failed(
		...
		return new FIPSHealthCheckResult(
			FIPSHealthCheckStatus.FAILED, providerName, failedTest, fipsState,
			providerMessage);
	}

	public static FIPSHealthCheckResult healthy(String providerName) {
		return new FIPSHealthCheckResult(
			FIPSHealthCheckStatus.HEALTHY, providerName, null, null, null);
	}

	public static FIPSHealthCheckResult inProgress() {
		return new FIPSHealthCheckResult(
			FIPSHealthCheckStatus.IN_PROGRESS, null, null, null, null);
	}

	public static FIPSHealthCheckResult notApplicable() {
		return new FIPSHealthCheckResult(
			FIPSHealthCheckStatus.NOT_APPLICABLE, null, null, null, null);
	}
	...
	public FIPSHealthCheckStatus getStatus() {
		return _status;
	}

	private FIPSHealthCheckResult(
		FIPSHealthCheckStatus status, String providerName, String failedTest,
		String fipsState, String providerMessage) {
	...
	private final FIPSHealthCheckStatus _status;
