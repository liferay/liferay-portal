...
describe('utils', () => {
	describe('getOperatorLabel', () => {
		it.each`
			...
			${EQ}                      | ${PropertyTypes.SessionChannel}      | ${Liferay.Language.get('is').toLowerCase()}
			${NE}                      | ${PropertyTypes.SessionChannel}      | ${Liferay.Language.get('is-not').toLowerCase()}
			${EQ}                      | ${PropertyTypes.SessionUtmParameter} | ${Liferay.Language.get('is').toLowerCase()}
			${isUnknown}               | ${PropertyTypes.SessionUtmParameter} | ${Liferay.Language.get('is-unknown').toLowerCase()}
	...
	describe('maybeFormatValue', () => {
		it.each`
			...
			${'Test'}              | ${PropertyTypes.SessionChannel}      | ${'"Test"'}
			${'Test'}              | ${PropertyTypes.SessionUtmParameter} | ${'"Test"'}
